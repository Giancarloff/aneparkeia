...
From this, we should get that $\negset{\emptyset} = \mathbb{U}$, $\negset{\U} = \emptyset$, $\emptyset \subseteq \U$, and $\neg (\U \subseteq \emptyset)$.
...
We can postulare a finite amount of constants in a finite formula. As an example, here is the formula for two constans: \begin{equation}
